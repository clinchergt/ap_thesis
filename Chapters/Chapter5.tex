...
Primero se eligió un peso para los parámetros de \textit{dropout} y después se eligió un $\gamma$ óptimo basado en la herramienta de \texttt{lr_find} (figura \ref{fig:claslr}).
