...
% Double spacing might be required for Galileo *CHECK*
...
\author{Jacobo \textsc{Del Valle}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\emph{Autor:}\\
\href{mailto:delvallejacobo@galileo.edu}{\authorname} % Author name - remove the \href bracket to remove the link
\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.4\textwidth}
\begin{flushright} \large
\emph{Supervisor:} \\
\href{mailto:alilemus@galileo.edu}{\supname} % Supervisor name - remove the \href bracket to remove the link  
\end{flushright}
\end{minipage}\\[3cm]
 
\vfill

\large \textit{Presentación de trabajo escrito para examen privado cumpliendo\\
los requerimientos para el título de \degreename}\\[0.3cm] % University requirement text
\textit{en el}\\[0.4cm]
...
Debo agradecerles también a mis supervisores\ldots
