...
Este trabajo presenta la tarea del perfilamiento de autores como una tarea que puede ser abordada con aprendizaje profundo y que también puede aplicarse el concepto de \textit{transfer learning} en el área de NLP de manera exitosa. Este concepto permite poder realizar tareas con menos datos de lo antes asumido.

Los resultados obtenidos con este proyecto alcanzan niveles del estado del arte de técnicas de aprendizaje profundo y son comparables con resultados obtenidos utilizando ambas técnicas tradicionales y de aprendizaje profundo.
\end{abstract}
