...
Los resultados obtenidos con este proyecto alcanzan niveles del estado del arte y se comparan con resultados obtenidos utilizando técnicas tradicionales y de aprendizaje profundo.
\end{abstract}
